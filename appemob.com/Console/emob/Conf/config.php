...
return array(
    ...
    'HTML_FILE_SUFFIX'  =>  '', // 设置静态缓存后缀为.shtml
    'HTML_CACHE_RULES'=> array(
		'app:index'=>array('{:group}_{:module}_{:action}_{app}_{rel}_{mid}','3600'),
    ),

    //图片域名地址
    'IMG_DOMAIN' => "//lh3.googleusercontent.com",

    //配置广告类型
    'AD_CONTROL_TYPE' =>array('a' =>'banner','b' => 'interstitial','c' => 'box'),
    'AD_CONTROL_DEFAULT' =>array('a' => false,'b' => false, 'c' => false),

    //邮箱域名地址
    'MAIL_DOMAIN' => "http://console.appemob.com"
);
?>